...
//internal class CurrentPlaceActivity : AppCompatActivity(), OnMapReadyCallback {
//
...
//
//}
open class CurrentPlaceActivity :AppCompatActivity(){
    ...
    lateinit var text1: TextView1
    lateinit var text2: TextView1
